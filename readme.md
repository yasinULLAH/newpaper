<div align="center">
  ...
  <h1><b>📰 Pakistan & Islamic Times | پاکستان اور اسلامک ٹائمز 📰</b></h1>
  <p>
    <b>A feature-rich, dynamic, and bilingual (English & Urdu) newspaper management system built with native PHP and MySQL. This project includes two complete newspaper applications: a general news version and an Islamic news version.</b>
    <br> | <br>
    <b>پی ایچ پی اور مای ایس کیو ایل میں بنایا گیا ایک خصوصیات سے بھرپور، متحرک، اور دو لسانی (انگریزی و اردو) اخباری نظام۔ اس پروجیکٹ میں دو مکمل اخباری ایپلیکیشنز شامل ہیں: ایک عمومی اخباری ورژن اور ایک اسلامی اخباری ورژن۔</b>
  </p>
...
- **[🚀 Key Features](#-key-features--اہم-خصوصیات)**
  ...
  - [Monetization | منیٹائزیشن](#-monetization--منیٹائزیشن)
...
This project contains two comprehensive, single-file web applications that function as complete newspaper and content management systems. It was built to demonstrate a wide range of web development features in a real-world context, from dynamic content creation and user authentication to advanced administrative controls and monetization features. Both applications are fully bilingual, offering a seamless experience for both English and Urdu readers and content creators.

The two included newspaper applications are:
*   **Pakistan Times:** A general-purpose newspaper for national, international, and other news.
*   **Islamic Times:** A newspaper focused on Islamic news, scholarship, and culture.

<br> | <br>

اس پروجیکٹ میں دو جامع، سنگل فائل ویب ایپلیکیشنز ہیں جو مکمل اخباری اور مواد کے انتظام کے نظام کے طور پر کام کرتی ہیں۔ اسے حقیقی دنیا کے تناظر میں ویب ڈویلپمنٹ کی وسیع خصوصیات کو ظاہر کرنے کے لیے بنایا گیا تھا، جس میں متحرک مواد کی تخلیق اور صارف کی تصدیق سے لے کر جدید انتظامی کنٹرولز اور منیٹائزیشن کی خصوصیات شامل ہیں۔ دونوں ایپلیکیشنز مکمل طور پر دو لسانی ہیں، جو انگریزی اور اردو قارئین اور مواد تخلیق کرنے والوں دونوں کے لیے ایک ہموار تجربہ پیش کرتی ہیں۔

شامل دو اخباری ایپلیکیشنز یہ ہیں:
*   **پاکستان ٹائمز:** قومی، بین الاقوامی اور دیگر خبروں کے لیے ایک عمومی اخبار۔
*   **اسلامک ٹائمز:** اسلامی خبروں، اسکالرشپ اور ثقافت پر مرکوز ایک اخبار۔
...
| **Profile Page** | **User Submissions** | **Broken Link Checker** |
| ![Screenshot 10](pic%20(10).png) | ![Screenshot 11](pic%20(11).png) | ![Screenshot 12](pic%20(12).png) |
...
* **📧 Contact Form & Newsletter** | **📧 رابطہ فارم اور نیوز لیٹر**: Includes a functional contact form that sends emails to the site admin, and a newsletter subscription form. | ایک فعال رابطہ فارم شامل ہے جو سائٹ ایڈمن کو ای میل بھیجتا ہے، اور ایک نیوز لیٹر سبسکرپشن فارم۔
* **📱 Social Sharing** | **📱 سوشل شیئرنگ**: Users can easily share articles on WhatsApp, Twitter, and Facebook, or copy the article link. | صارفین آسانی سے واٹس ایپ، ٹویٹر، اور فیس بک پر مضامین شیئر کر سکتے ہیں، یا مضمون کا لنک کاپی کر سکتے ہیں۔
...
* **💸 Ad Units** | **💸 اشتہاری اکائیاں**: A system for creating and managing ad units (banner, inline, popup) to be displayed in various locations on the site. | سائٹ پر مختلف مقامات پر دکھائے جانے کے لیے اشتہاری اکائیاں (بینر، ان لائن، پاپ اپ) بنانے اور ان کا نظم کرنے کا ایک نظام۔
* **💳 Subscription Plans** | **💳 سبسکرپشن پلانز**: A complete system for creating and managing subscription plans, allowing you to offer premium content to subscribers. | سبسکرپشن پلان بنانے اور ان کا نظم کرنے کا ایک مکمل نظام، جو آپ کو سبسکرائبرز کو پریمیم مواد پیش کرنے کی اجازت دیتا ہے۔
...
* **📄 Print-Friendly** | **📄 پرنٹ کے لیے موزوں**: Includes print-friendly CSS to ensure articles look great when printed. | پرنٹ کے لیے موزوں CSS شامل ہے تاکہ پرنٹ ہونے پر مضامین بہترین نظر آئیں۔
* **⏳ Loading Spinner & Progress Bar** | **⏳ لوڈنگ اسپنر اور پروگریس بار**: A loading spinner is displayed during AJAX operations, and a reading progress bar is shown on article pages. | AJAX آپریشنز کے دوران ایک لوڈنگ اسپنر دکھایا جاتا ہے، اور مضامین کے صفحات پر ایک ریڈنگ پروگریس بار دکھایا جاتا ہے۔
...
| `subscription_plans` | Stores details about the available subscription plans. |
| `subscriptions` | Tracks user subscriptions to the available plans. |
| `...and more` | Other tables for tags, etc. |
...
1.  **Clone the Repository** | **ریپوزٹری کلون کریں**
    ```bash
    git clone https://github.com/yasinULLAH/newpaper.git
    ```
...
3.  **Choose Your Newspaper Version** | **اپنا اخباری ورژن منتخب کریں**
    * This project includes two versions. Choose one to run:
        *   **For the General Newspaper (Pakistan Times):** Use the `general newspaper index.php` file. You can rename it to `index.php` for easier access.
        *   **For the Islamic Newspaper (Islamic Times):** Use the `islamic newspaper index.php` file. You can rename it to `index.php` for easier access.
    *   **Note:** The `index.php` in the root of the project is a duplicate of the `islamic newspaper index.php`.

4.  **Configure Database Connection** | **ڈیٹا بیس کنکشن تشکیل دیں**
    * Open the PHP file you chose in a code editor. | کوڈ ایڈیٹر میں اپنی منتخب کردہ PHP فائل کھولیں۔
...
5.  **Run the Application** | **ایپلیکیشن چلائیں**
    ...
    * Open your web browser and navigate to `http://localhost/newpaper` (or whatever you named the folder). | اپنا ویب براؤزر کھولیں اور `http://localhost/newpaper` پر جائیں (یا آپ نے فولڈر کا جو بھی نام رکھا ہے)۔
    * The application will automatically create the database, all tables, and seed initial data (admin user, categories, and sample articles). | ایپلیکیشن خود بخود `newspaper_db` یا `islamic_newspaper_db` ڈیٹا بیس، تمام ٹیبلز، اور ابتدائی ڈیٹا (ایڈمن صارف، زمرے، اور نمونہ مضامین) بنا دے گی۔
